...
public class DieselOrderActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DBDiesel databaseHelper = new DBDiesel(DieselOrderActivity.this);
                ...
                if (isOnlinePaymentSelected) {
                    ...
                    Intent intent = new Intent(DieselOrderActivity.this, OnlinePaymentActivity.class);
                    startActivity(intent);
                } else {
                    // Display a toast message for successful order placement
                    Toast.makeText(DieselOrderActivity.this, "Order placed successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
